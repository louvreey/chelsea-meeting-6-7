...
left_eye = cv2.imread('C:\Meeting_6\assets\eye1.png')
right_eye = cv2.imread('C:\Meeting_6\assets\eye2.png')
smoke_animation = cv2.VideoCapture('C:\Meeting_6\assets\smoke_animation.mp4')
